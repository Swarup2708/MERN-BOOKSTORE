...
const BookCard = ({book, setBooks}) => {
    ...
    return (
        <>
        {/* CARD */}
        <Link to={`/books/${book._id}`} className={`relative block rouded-x1 bg-base-100 p-4 border transition-all duration-200${isActive ? "border-primary shadow-lg":"border-base-300"} hover:border-primary hover:shadow-xl`}>
